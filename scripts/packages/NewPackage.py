...
--------------
    ...
    python scripts/packages/NewPackage.py Index.Foo

    # Engine package, C# only (Serialization-style):
    python scripts/packages/NewPackage.py Index.Foo --layers csharp

    # Engine package, native + C# wired together (Tilemap2D-style):
    python scripts/packages/NewPackage.py Index.Foo --layers native+csharp
    ...
    python scripts/packages/NewPackage.py Index.Foo --no-premake
...
MANIFEST_TEMPLATE = """\
-- {name} — generated by scripts/packages/NewPackage.py.
--
...
//
// Pass `--component <Name>` to scripts/packages/NewPackage.py to scaffold an example
...
// {componentName}Component — generated by scripts/packages/NewPackage.py --component.
//
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    if args.project:
        ...
        if cwd != REPO_ROOT and (cwd / "index-project.json").is_file():
            ...
            print(f"               python scripts/packages/NewPackage.py {name} --layers {args.layers} --project \"{cwd}\"")
            print()
