...
public class Button : Component
{
    ...
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Button_GetNormalSprite(RequireComponent<Button>()));
        set => InternalCalls.Button_SetNormalSprite(RequireComponent<Button>(), value?.UUID ?? 0);
    }
    public Texture? HoveredSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Button_GetHoveredSprite(RequireComponent<Button>()));
        set => InternalCalls.Button_SetHoveredSprite(RequireComponent<Button>(), value?.UUID ?? 0);
    }
    public Texture? PressedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Button_GetPressedSprite(RequireComponent<Button>()));
        set => InternalCalls.Button_SetPressedSprite(RequireComponent<Button>(), value?.UUID ?? 0);
    }
    public Texture? DisabledSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Button_GetDisabledSprite(RequireComponent<Button>()));
        set => InternalCalls.Button_SetDisabledSprite(RequireComponent<Button>(), value?.UUID ?? 0);
    }
    public Texture? FocusedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Button_GetFocusedSprite(RequireComponent<Button>()));
...
public class Slider : Component
{
    ...
    public Texture? NormalSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Slider_GetNormalSprite(RequireComponent<Slider>()));
        set => InternalCalls.Slider_SetNormalSprite(RequireComponent<Slider>(), value?.UUID ?? 0);
    }
    public Texture? HoveredSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Slider_GetHoveredSprite(RequireComponent<Slider>()));
        set => InternalCalls.Slider_SetHoveredSprite(RequireComponent<Slider>(), value?.UUID ?? 0);
    }
    public Texture? PressedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Slider_GetPressedSprite(RequireComponent<Slider>()));
        set => InternalCalls.Slider_SetPressedSprite(RequireComponent<Slider>(), value?.UUID ?? 0);
    }
    public Texture? DisabledSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Slider_GetDisabledSprite(RequireComponent<Slider>()));
        set => InternalCalls.Slider_SetDisabledSprite(RequireComponent<Slider>(), value?.UUID ?? 0);
    }
    public Texture? FocusedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Slider_GetFocusedSprite(RequireComponent<Slider>()));
...
public class Toggle : Component
{
    ...
    public Texture? NormalSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Toggle_GetNormalSprite(RequireComponent<Toggle>()));
        set => InternalCalls.Toggle_SetNormalSprite(RequireComponent<Toggle>(), value?.UUID ?? 0);
    }
    public Texture? HoveredSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Toggle_GetHoveredSprite(RequireComponent<Toggle>()));
        set => InternalCalls.Toggle_SetHoveredSprite(RequireComponent<Toggle>(), value?.UUID ?? 0);
    }
    public Texture? PressedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Toggle_GetPressedSprite(RequireComponent<Toggle>()));
        set => InternalCalls.Toggle_SetPressedSprite(RequireComponent<Toggle>(), value?.UUID ?? 0);
    }
    public Texture? DisabledSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Toggle_GetDisabledSprite(RequireComponent<Toggle>()));
        set => InternalCalls.Toggle_SetDisabledSprite(RequireComponent<Toggle>(), value?.UUID ?? 0);
    }
    public Texture? FocusedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Toggle_GetFocusedSprite(RequireComponent<Toggle>()));
...
public class InputField : Component
{
    ...
    public Texture? NormalSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.InputField_GetNormalSprite(RequireComponent<InputField>()));
        set => InternalCalls.InputField_SetNormalSprite(RequireComponent<InputField>(), value?.UUID ?? 0);
    }
    public Texture? HoveredSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.InputField_GetHoveredSprite(RequireComponent<InputField>()));
        set => InternalCalls.InputField_SetHoveredSprite(RequireComponent<InputField>(), value?.UUID ?? 0);
    }
    public Texture? PressedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.InputField_GetPressedSprite(RequireComponent<InputField>()));
        set => InternalCalls.InputField_SetPressedSprite(RequireComponent<InputField>(), value?.UUID ?? 0);
    }
    public Texture? DisabledSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.InputField_GetDisabledSprite(RequireComponent<InputField>()));
        set => InternalCalls.InputField_SetDisabledSprite(RequireComponent<InputField>(), value?.UUID ?? 0);
    }
    public Texture? FocusedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.InputField_GetFocusedSprite(RequireComponent<InputField>()));
...
public class Dropdown : Component
{
    ...
    public Texture? NormalSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Dropdown_GetNormalSprite(RequireComponent<Dropdown>()));
        set => InternalCalls.Dropdown_SetNormalSprite(RequireComponent<Dropdown>(), value?.UUID ?? 0);
    }
    public Texture? HoveredSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Dropdown_GetHoveredSprite(RequireComponent<Dropdown>()));
        set => InternalCalls.Dropdown_SetHoveredSprite(RequireComponent<Dropdown>(), value?.UUID ?? 0);
    }
    public Texture? PressedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Dropdown_GetPressedSprite(RequireComponent<Dropdown>()));
        set => InternalCalls.Dropdown_SetPressedSprite(RequireComponent<Dropdown>(), value?.UUID ?? 0);
    }
    public Texture? DisabledSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Dropdown_GetDisabledSprite(RequireComponent<Dropdown>()));
        set => InternalCalls.Dropdown_SetDisabledSprite(RequireComponent<Dropdown>(), value?.UUID ?? 0);
    }
    public Texture? FocusedSprite
    {
        get => Axiom.Texture.FromAssetUUID(InternalCalls.Dropdown_GetFocusedSprite(RequireComponent<Dropdown>()));
